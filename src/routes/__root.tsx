...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "StudyFlow — student study tracker" },
      {
        name: "description",
        content:
          "Track your syllabus, run focus sessions, build streaks and plan your week with StudyFlow.",
      },
      { property: "og:title", content: "StudyFlow — student study tracker" },
      {
        property: "og:description",
        content: "Syllabus tracking, focus timer, analytics and a weekly study planner.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "Syllune" },
    ],
    links: [
      {
        rel: "stylesheet",
